...
// configuration step. It creates a namespace called `all_rounded`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        all_rounded::cmake::project_name,
        all_rounded::cmake::project_version));// version string, acquired
